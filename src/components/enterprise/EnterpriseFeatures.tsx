...
const EnterpriseFeaturesCard = ({feature}: EnterpriseFeaturesCardProps) => {
  return (
    <div
      className="rounded-3xl w-[450px] h-60 p-8 flex flex-col items-start space-y-4"
      style={{
        border: "1px solid #E7E7E7",
      }}
    >
      <feature.logo />
      <p className="text-title-medium">{feature.title}</p>
      <p className="text-title-tiny font-normal">{feature.description}</p>
    </div>
  )
}
...
const EnterpriseFeatures = () => {
  return (
    <section className="my-24">
      <h4 className="text-display-small text-center">Some of our enterprise features.</h4>
