...
const EnterpriseFeaturesCard = ({
  feature
}: EnterpriseFeaturesCardProps): JSX.Element => {
  return (
    <div className="border border-solid border-tailCall-border-light-400 rounded-3xl w-full sm:w-[450px] sm:h-60 p-SPACE_08 flex flex-col items-start space-y-SPACE_04">
      ...
      <p className="text-content-tiny sm:text-content-small font-normal">
        {feature.description}
      </p>
    </div>
  )
...
const EnterpriseFeatures = () => {
  return (
    <section className="my-SPACE_16 sm:my-SPACE_20 lg:my-24">
      <Heading
        as="h4"
        className="text-title-semi-large sm:text-display-tiny lg:text-display-small text-center"
      >
