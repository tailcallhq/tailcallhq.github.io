...
const Pricing = () => {
  return (
    <section className="my-14 sm:my-24">
      <h4 className="text-title-large sm:text-display-small text-center mb-6 sm:mb-10">
        ...
        {pricingPlans.map((plan) => (
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-content-small sm:text-content-medium text-center">{plan.name}</span>
              <span className="text-title-large sm:text-display-tiny text-center">{plan.price}</span>
              <span className="text-content-small sm:text-content-small text-center">{plan.for}</span>
              <span className="text-content-small sm:text-content-small text-center">{plan.billing}</span>
              <span className="text-content-small sm:text-content-small text-center">{plan.volumeDiscounts}</span>
            </div>
