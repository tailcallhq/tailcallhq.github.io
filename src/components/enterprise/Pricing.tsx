...
const Pricing = (): JSX.Element => {
  return (
    <section className="my-SPACE_14 sm:my-24 sm:mx-SPACE_04 lg:mx-0">
      ...
      >
        <span className="rounded sm:rounded-lg bg-tailCall-yellow px-SPACE_01">
          Plans
        </span>{" "}
        that fit your scale.
      </Heading>
      ...
      <div className="flex flex-col mx-SPACE_04 sm:mx-0 lg:flex-row items-center justify-center gap-SPACE_06 md:px-SPACE_16">
        {pricingPlans.map((plan) => (
          <div
            ...
            className={`${
              plan.mostPopular
                ? "border-tailCall-border-dark-700"
                : "border-tailCall-border-light-400"
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-content-small lg:text-content-medium text-center">
                {plan.name}
              </span>
              <span className="text-title-large  lg:text-display-tiny text-center">
                {plan.price}
              </span>
              <span className="text-content-small text-center">{plan.for}</span>
              <span className="text-content-small text-center">
                {plan.billing ? plan.billing : <br />}
              </span>
              <span className="text-content-small text-center">
            ...
            <div className="flex-[0.8] flex flex-col items-center justify-between">
              <div className="flex flex-col items-start justify-start gap-SPACE_04 px-SPACE_08">
                {plan.features.map((feature) => (
                  <div
                    key={feature.id}
                    className="flex items-center space-x-SPACE_03 m-0 p-0"
                  >
              ...
              <div className="hidden sm:block text-center mx-SPACE_04">
                <LinkButton
                  ...
                  onClick={() =>
                    analyticsHandler("Pricing", "Click", `${plan.buttonText}`)
                  }
                  href={plan.href}
