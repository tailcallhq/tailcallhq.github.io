    ...
    <div className="max-w-2xl mx-auto p-6 bg-gradient-to-r from-purple-100 to-blue-100 shadow-lg rounded-xl">
      ...
      {showScore ? (
        <div className="text-center">
          <p className="text-2xl mb-4 font-semibold text-gray-700">You scored {score} out of {questions.length}</p>
          {score > 3 ? (
            <div className="flex flex-col items-center">
              <p className="text-5xl mb-4">🎉</p>
              <p className="text-green-600 font-bold text-xl">Congratulations! You're a GraphQL schema change expert!</p>
            </div>
          ) : (
            <div className="flex flex-col items-center">
        ...
        <div>
          <p className="mb-4 text-lg font-semibold text-gray-600">Question {currentQuestion + 1}/{questions.length}</p>
