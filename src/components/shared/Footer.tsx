...
const Footer = (): JSX.Element => {
  ...
  return (
    <footer className="bg-black grid-background-footer pt-SPACE_10 pb-SPACE_05 flex flex-col items-center justify-center gap-SPACE_10 w-full relative px-SPACE_04">
