  ...
  return (
    ...
    >
      <div className="flex flex-col items-center bg-gradient-to-b from-tailCall-dark-300 to-tailCall-dark-500 rounded-2xl py-SPACE_12 text-center text-tailCall-light-200">
        {title}
        <p className="text-tailCall-light-300 mt-SPACE_10 text-content-small md:text-content-medium max-w-sm md:max-w-md">{`"${testimonial.review}"`}</p>
...
const Testimonials = (): JSX.Element => {
  return (
    <section className="bg-tailCall-dark-500 w-full relative flex flex-col justify-center gap-y-24 lg:px-SPACE_16 text-tailCall-light-100 py-4 sm:py-12 lg:py-24">
      {/* Background image */}
      <img
        src={require("@site/static/images/home/bg-map.png").default}
        alt=""
        className="absolute -translate-x-1/2 left-1/2 top-0 z-10"
      />
      <div className="pt-24">
