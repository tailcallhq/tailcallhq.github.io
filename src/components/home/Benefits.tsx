...
const LegacyGateway = (): JSX.Element => {
  return (
    <section className="w-full my-SPACE_12 lg:px-SPACE_16">
      ...
      <div className="flex w-[100%] lg:flex-row space-y-SPACE_06 items-center justify-between lg:space-x-SPACE_06 lg:space-y-0">
        {benefits.map((item) => (
          <div
            className="border border-solid border-tailCall-border-dark-300 w-[50%] lg:min-h-[358px] lg:max-w-md rounded-3axl p-SPACE_04 flex flex-col items-start justify-between"
            key={item.id}
          >
