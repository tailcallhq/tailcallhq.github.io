...
const LegacyGateway = (): JSX.Element => {
  return (
    <section className="w-full md:pt-10 p-10 lg:px-SPACE_16 bg-[#1C1D1F]">
      <div>
      ...
      <div className="flex w-[100%] flex-wrap items-center justify-center">
        {benefits.map((item) => (
          <div
            className="border border-solid border-tailCall-border-dark-300 md:w-[40%]  rounded-3xl md:px-10 px-4 py-2 md:flex items-center justify-between md:m-4 mb-10 hover:border-[#FDEA2E]"
            key={item.id}
          >
            ...
            <div>
              <p className="text-title-small text-white sm:text-title-large mt-SPACE_04 mb-SPACE_02 sm:mb-0">{item.title} <span className="h-16 w-16"><ArrowRight/></span></p>
