  ...
  return (
    <div className="mt-16 md:mb-0 mb-10">
      <div className="md:flex md:flex-wrap justify-center gap-10 w-[100%]">
        {benefits.map((item) => (
          <a
            className="md:w-[40%] lg:w-[45%] lg:flex !no-underline"
            key={item.id}
            href={item.redirection_url}
            target="_blank"
          >
            <div className="group border border-solid border-tailCall-border-dark-300 rounded-3xl  md:px-10 px-4 py-2 pt-4  benefits-drop-shadow hover:border-[#FDEA2E] md:mb-0 mb-6 cursor-pointer">
