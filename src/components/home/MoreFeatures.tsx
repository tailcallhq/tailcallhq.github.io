...
const FeatureBox = ({feature}) => {
  return (
    <div
      ...
      className="flex flex-col sm:flex-row items-start justify-start sm:items-center text-start space-y-2 py-4 sm:py-8 lg:py-12 sm:space-x-4 text-content-tiny font-bold sm:text-title-small lg:text-title-medium text-tailCall-dark-500  sm:h-32 w-full border border-tailCall-dark-300"
    >
