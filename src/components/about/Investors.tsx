  ...
  return (
    <section className="h-full w-full relative">
      <p className="pt-SPACE_04 text-title-semi-large sm:text-title-large lg:text-display-tiny text-center w-full px-SPACE_04 sm:mx-0 sm:mt-SPACE_09">
        We are backed by{" "}
        <span className="bg-tailCall-yellow rounded-lg px-SPACE_02">
      ...
      <div className="mt-SPACE_16 sm:mt-SPACE_20 lg:mt-24">
        <p className="text-title-semi-large sm:text-title-large lg:text-display-tiny text-center">
          Angel Investors
        </p>
        <div className="flex flex-wrap lg:flex-nowrap gap-SPACE_12 sm:gap-y-SPACE_06 lg:gap-y-0 items-center flex-start justify-center mt-SPACE_09">
          {investors.map((investor) => (
            <div
              key={investor.id}
              className="flex flex-col items-center w-[172px] sm:w-[228px]"
            >
              <img
                src={investor.image}
              ...
              />
              <span className="text-title-tiny mt-SPACE_02">
                {investor.name}
              </span>
              <span className="text-content-small text-tailCall-dark-500 text-center">
                {investor.title}
              </span>
            </div>
          ))}
