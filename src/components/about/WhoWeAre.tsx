...
const WhoWeAre = () => {
  return (
    <section className="mt-8 sm:mt-10 lg:mt-20 flex flex-col sm:flex-row items-start justify-center sm:space-x-10 lg:space-x-20 px-4 sm:px-10 lg:px-40 2xl:max-w-[90rem] mx-auto">
