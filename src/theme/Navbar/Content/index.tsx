...
const CustomSearch = () => {
  ...
  useEffect(() => {
    ...
    if (searchContainer) searchContainer.addEventListener("DOMSubtreeModified", focusCb)

    return () => {
      if (searchContainer) searchContainer.removeEventListener("DOMSubtreeModified", focusCb)
    }
  }, [])
