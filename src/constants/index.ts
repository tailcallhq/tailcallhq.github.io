...
export const tailCallBenchmarkUrl =
  "https://github.com/tailcallhq/graphql-benchmarks#benchmark-results"
export const tailCallBlogUrl = "https://blog.tailcall.run/"
export const codeSandboxUrl =
  "https://codesandbox.io/p/github/tailcallhq/tailcall-sandbox/main"
export const zapierLink =
  "https://hooks.zapier.com/hooks/catch/2793322/3a1gxp2/"
...
export const enterpriseFeatures: EnterpriseFeature[] = [
  {
    ...
    description:
      "Adaptive optimisation by analysing the hot queries in your Production environment"
  },
  {
    id: 2,
    ...
    description:
      "Ability to set global rate limits on access of each field of your data graph."
  },
  {
    id: 3,
    ...
    description:
      "The change in any Tailcall config gets seamlessly reflected on your GraphQL. "
  },
  {
    id: 4,
