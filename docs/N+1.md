...
To get a deeper understanding of what this N + 1 issue is, we can use the [--n-plus-one-queries](/docs/cli/#--n-plus-one-queries) parameter with the `check` command:
