---
title: "Getting Started with Tailcall: A Comprehensive Guide"
slug: /getting-started-with-graphql
sidebar_position: 2
description: "Get started with Tailcall! Follow our comprehensive guide to set up and begin leveraging the power of Tailcall for your API needs."
sidebar_label: Getting Started
---

<Head>
  <title>Install Tailcall | Step By Step Guide</title>
</Head>
import CodeBlock from "@theme/CodeBlock" import Version from "../src/components/Version" import InstallCommand from "../src/components/install"
...
## Writing a Tailcall Configuration
...
## Making GraphQL requests to the Tailcall server
