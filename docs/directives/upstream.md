---
title: Configuring Upstream Connections
description: Control upstream server connections, manage settings like timeouts and proxies, and enhance API efficiency with the upstream directive.
slug: upstream-directive
sidebar_label: Configuring Upstream
---
