---
title: Integrating REST APIs
description: The @rest directive enables GraphQL to orchestrate RESTful services by mapping queries to REST endpoints, facilitating seamless integration with existing API infrastructures.
slug: rest-directive
