...
Once you've deployed Tailcall for the first time, you can edit `config/config.graphql` to [build your API](../../guides/getting-started/#configuration). If you [install Tailcall locally](../../guides/getting-started/#installation), you can test your config by running:
