...
1. Edit the `@upstream` to enable [batching](https://tailcall.run/docs/operators/server/#batchrequests), this reduces the number of requests by grouping multiple requests into a single batch request:
