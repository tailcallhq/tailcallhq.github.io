...
Use this to manually install and setup Tailcall on your machine.

<CodeBlock language="bash">
  curl -sSL
  https://raw.githubusercontent.com/tailcallhq/tailcall/main/install.sh | bash
  -s -- {versionData.tag_name}
</CodeBlock>
