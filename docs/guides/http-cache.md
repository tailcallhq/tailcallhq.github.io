...
To further enhance the performance of any API with Tailcall, integrating the [`@cache`](./directives.md#cache) directive offers protocol agnostic control over caching at the field level within a GraphQL schema.
