...
To further enhance the performance of any API with Tailcall, integrating the [`@cache`](/directives/cache.md) directive offers protocol agnostic control over caching at the field level within a GraphQL schema.
