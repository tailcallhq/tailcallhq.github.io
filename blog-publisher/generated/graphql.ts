...
export type CreateDraftMutation = {
  ...
  createDraft: {
    __typename?: "CreateDraftPayload"
    draft?: {__typename?: "Draft"; id: string; title?: string | null} | null
  }
}
...
export type PublishPostMutation = {
  ...
  publishPost: {
    __typename?: "PublishPostPayload"
    post?: {__typename?: "Post"; id: string; slug: string; title: string; subtitle?: string | null} | null
  }
}
...
export type GetPostsQuery = {
  ...
  publication?: {
    ...
    posts: {
      __typename?: "PublicationPostConnection"
      edges: Array<{__typename?: "PostEdge"; node: {__typename?: "Post"; id: string; title: string; slug: string}}>
      ...
      variableDefinitions: [
        {
          ...
          type: {kind: "NonNullType", type: {kind: "NamedType", name: {kind: "Name", value: "CreateDraftInput"}}},
        },
      ],
      selectionSet: {
        kind: "SelectionSet",
      ...
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {kind: "Variable", name: {kind: "Name", value: "input"}},
          type: {kind: "NonNullType", type: {kind: "NamedType", name: {kind: "Name", value: "PublishDraftInput"}}},
        },
      ],
      selectionSet: {
        kind: "SelectionSet",
      ...
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {kind: "Variable", name: {kind: "Name", value: "input"}},
          type: {kind: "NonNullType", type: {kind: "NamedType", name: {kind: "Name", value: "PublishPostInput"}}},
        },
      ],
      selectionSet: {
        kind: "SelectionSet",
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {kind: "Variable", name: {kind: "Name", value: "publicationId"}},
            ...
            arguments: [
              {
                ...
                value: {kind: "Variable", name: {kind: "Name", value: "publicationId"}},
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
