...
If you are here that means you either know how to design your own schemas from scratch and are ready to play with it or you are coming here from our previous post where we introduced to the world of GraphQL schemas. Either way we are so proud of the inquisitive coder in you to be able to wander through the alleys of the million articles to land here! 

Before you dive into another intricacy of GraphQL we love talking about here are a few notes and if we may dare, tl,dr of the article.
This is a multiple part series and we keep expanding on it from time to time.

TL;DR: Adding Without Breaking: The Art of Additive Changes

- Safe Changes: Adding fields/types is generally safe but watch for edge cases like changing resolver behavior with optional arguments.
- Breaking Changes: Adding required arguments or new enum values can break clients; use default values and advise clients on handling new cases.
- Complex Types: Adding new implementations to interfaces or members to unions can cause runtime errors; ensure clients implement exhaustive type checks.
...
Alright awesome you all! You have successfully completed the second part of our series!! Pat yourself and you know, maybe high five your cat! Here are the links to the next blogs in the series that have already been published.

![cat giving high five](../static/images/blog/cat-high-five-gif.webp)

- [Next Part](/blog/graphql-schema-part-2-2)
Here we will dive into removing schema elements and handling breaking changes!
